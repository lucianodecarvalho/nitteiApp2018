...
public class AtividadeListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    public boolean onQueryTextChange(String query) {
        List<ActivityContent.ActivityItem> items = filter( ActivityContent.ITEMS, query);
    ...
    private List<ActivityContent.ActivityItem> filter(List<ActivityContent.ActivityItem> items, String query) {
        final String lowerCaseQuery = query.toLowerCase();

        final List<ActivityContent.ActivityItem> filteredDummyItemList = new ArrayList<>();
        for (ActivityContent.ActivityItem item : items) {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if (mValues.get(position).getId().equals(todayDate.toString())){
                ...
                holder.mContentView.setText(mValues.get(position).content + " " + "/n" + "É hojeeee");
